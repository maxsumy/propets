...
class Adding_new_found extends React.Component{
    constructor(){
        super();
    }
    render() {
                        ...
                        <div className="middle-side-container">
                            ...
                            <div className="middle-side-header">
                                <div className="middle-side-header-text">
                                    <p><span className="lost-text">Found a pet?</span> Please complete the form to help.</p>
                                </div>
                            </div>
...
export default Adding_new_found;